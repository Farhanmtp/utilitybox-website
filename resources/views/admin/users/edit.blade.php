                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" minlength="6" name="password" id="password" class="form-control"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="address2" id="address2" class="form-control"
                                   value="{{ data_get($user,'address2') }}" placeholder="Enter address line 2">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                                ...
                                @foreach($roles as $role)
                                    ...
                                    @else
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" {{ $user->hasRole($role->name) ?'checked':'' }} type="checkbox" id="role{{ $role->id }}" name="roles[]" value="{{ $role->id }}">
