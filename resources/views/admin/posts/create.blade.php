    ...
    <div class="card">
        <form action="{{ route('admin.posts.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-6"><h3 class="card-title">Add Post</h3></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="category_id" id="category_id" required class="form-control" data-live-search="true">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="content" id="content" rows="3"
                                      class="form-control tinymce">{{ old('content') }}</textarea>
                        </div>
                    </div>
                </div>
                <hr>
