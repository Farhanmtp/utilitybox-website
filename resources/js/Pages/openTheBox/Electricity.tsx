                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-lg-3 col-md-6">
                                <h5 className="mb-4 text-white">Best Electricity Deals for Hospitality Industry & More.</h5>
                            ...
                            <div className="col-lg-3 col-md-6">
                                <h5 className="mb-4 text-white">Never worry about losing time over billing charge mistake</h5>
                            ...
                            <div className="col-lg-3 col-md-6">
                                <h5 className="mb-4 text-white">Experienced Consultants</h5>
                            ...
                            <div className="col-lg-3 col-md-6">
                                <h5 className="mb-4 text-white">No overpaying of bills, forever</h5>
