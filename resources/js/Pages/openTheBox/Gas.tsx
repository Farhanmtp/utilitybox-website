                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6 col-sm-12 pb-4">
                            <Link style={{ textDecoration: "none" }} href="/invoice-verification">
                                <ServiceBox title="INVOICE VERIFICATION" content="Our team conducts thorough checks to validate the accuracy of your energy invoices, identifying and resolving any billing errors or discrepancies." imgUrl="/images/icons/audit.png" />
                            </Link>
                        </div>
                        <div className="col-lg-4 col-md-6 col-sm-12 pb-4">
