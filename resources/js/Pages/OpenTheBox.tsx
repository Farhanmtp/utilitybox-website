        ...
        <Layout>
            ...
            <div className="container-fluid">
                <div className="py-100" style={{ backgroundImage: `url(/images/openthebox.jpg)`, backgroundSize: "cover" }}>
                    <h1 className="text-center text-grey text-2xl md:text-4xl"><b>Introducing UMaaS</b> - Utility Management as a Service. <br />Streamline & Optimise your <b>utility management!</b>
                    </h1>
            ...
            <div className="container mx-auto py-5">
                <div className="flex justify-center items-center gap-5">
                    <div>
                        <h1 className="pb-5 text-2xl md:text-[40px] leading-[48px] max-w-[36rem]">Take <b>control</b> of your own <b>contracts</b></h1>
                        <BlueButton title="GET A DEAL!" link="/contact" />
                    </div>
                    <div className="flex justify-center">
                        <Image src="/images/home0a33.jpg" className="md:w-[75%] w-[100%]" />
                    </div>
                </div>
            </div>
            ...
            <div className="container py-16 pt-5 pb-5">
                <div className="row gap-5">
                    <div className="col-12 col-lg-5">
                        <h1 className="text-3xl md:text-[45px] md:leading-[54px]"><b>Revolutionise</b> your <b>utility management</b> with our expertise.</h1>
                    </div>
            ...
            <div className="container py-16 pt-5 pb-5">
                <div className="row gap-5">
                    <div className="col-12 col-lg-5">
                        <h1 className="text-3xl md:text-[40px] mb-4"><b>Our team</b> of experts<br /> will take care of<br /> every aspect</h1>
            ...
            <div className="container py-1">
                <div className="row gap-5 pt-5 pb-5">
                    <div className="col-12 col-lg-5">
                        <Image src="/images/change-your-plan.jpg" width="100%" className="md:w-[85%]" />
                    </div>
                    <div className="col-12 col-lg-6" style={{ alignSelf: "center" }}>
                        ...
                        <div className="bg-blue-to-light p-5 rounded mt-5">
                            <h5 className="mb-4 md:text-[18px] text-[18px] text-white"><b>FREE Audit</b><br /><br />
                            ...
                            <div className="md:flex gap-2">
                                <div className="mb-2"><WhiteBorderButton title="Call Us" link="tel:+442039219000" icon="phone" /></div>
                                <div className="mb-2"><WhiteBorderButton title="Email Us" link="mailto:info@utilitybox.org.uk" icon="mail" /></div>
                            </div>
            ...
            <div className="container py-16">
                ...
                <div className="row gap-5 pt-5 pb-5">
                    <div className="col-12 col-lg-5">
                        <h1 className="text-3xl md:text-4xl"><b>UMaaS</b> brings you <b>Swift Contract Generation System</b></h1>
                    </div>
                    <div className="col-12 col-lg-6">
                        <h4 className="mb-4 text-semibold">Powering Progress, Energising Tomorrow: SCSG Energy Solutions</h4>
                        <p>With our innovative Swift Contract Generation System, clients now have the power to generate their own contracts directly on our website effortlessly. Our user-friendly interface puts the control in the hands of the client, allowing them to navigate through the contract creation process with ease. By simply inputting the necessary details and preferences, our system dynamically generates customised contracts tailored to your specific needs. This not only saves valuable time but also ensures accuracy and consistency in contract creation. With Swift Contract Generation
