    ...
    return (
        <Layout>
            ...
            <div className="container pt-5 pb-5">
                <div className="row gap-5">
                    <div className="col-md-6 col-sm-12 align-self-center">
                        <h1 className="pb-5 text-2xl md:text-4xl">Take <b>control</b> of your own <b>contracts</b></h1>
            ...
            <div className="container py-16 pt-5 pb-5">
                <div className="row gap-5">
                    <div className="col-12 col-lg-5">
                        <h1 className="text-3xl md:text-4xl"><b>Revolutionise</b> your <b>utility management</b> with our expertise.</h1>
                    </div>
            ...
            <div className="container py-16 pt-5 pb-5">
                <div className="row gap-5">
                    <div className="col-12 col-lg-5">
                        <h1 className="text-3xl md:text-4xl mb-4"><b>Our team</b> of experts<br/> will take care of<br/> every aspect</h1>
